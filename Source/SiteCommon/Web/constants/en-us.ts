export const EN_US = {
    ...
    INIT_BLOB_SELECTION_TITLE: `Connect to your Azure Storage Account`,
    INIT_BLOB_SELECTION_SUBTITLE: `Set up a connection to your target blob storage account so we can analyze your data.`,
    ...
    INIT_GETTING_STARTED_AZURE_BLOB_STORAGE: `Azure Blob Storage`,
    ...
    INIT_GETTING_STARTED_WPA: `Workplace Analytics`,
    INIT_GETTING_STARTED_WPA_INSIGHTS: `Data pulled from your orginization to to gain orginizational insights`,
    ...
    INIT_WPA_PRICING_CALCULATOR_URL: `https://azure.microsoft.com/en-us/pricing/calculator/`,
    INIT_WPA_PRICING_COST: `By clicking next and deploying the template, you authorize Microsoft to create Azure resources on your subscription and bill based on their respective pricing rates. The approximate base cost of the Azure resources used by this template is <INSERT COST>. These costs are estimates only and subject to change.`,
    INIT_WPA_PRICING_URL: `https://github.com/Microsoft/BusinessPlatformApps/blob/dev/Source/Apps/Microsoft/Released/Microsoft-WorkplaceAnalytics/README.md#estimated-costs`,
    INIT_WPA_SUBTITLE: `Welcome to the Workplace Analytics solution template.`,
    INIT_WPA_TEMPLATE_NAME: `Workplace Analytics`,
